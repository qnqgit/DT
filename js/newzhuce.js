...
$('.e-mail').click(function(){
    ...
    $('.ipt').css('border','')
    $('.ipt input').val('')
    $('.ipt span').css('display','none').eq(1).html('<img src="../img/rico_error.png"> 邮箱账号格式错误')    
    //  验证码样式
...
$('.phone').click(function(){
    ...
    .next()
    .next()
    .html('<img src="../img/rico_error.png"> 手机号码格式错误')
})
    ...
    two.oninput = function(){
        ...
        for(var i=0; i<mima.length; i++){
            if(Number(len2) == 0){
                ...
                this.parentNode.style.border='rgb(209, 50, 50) solid 1px';  
                tishi2.style.display='block'   
                tishi2.innerHTML='<img src="../img/rico_error.png">密码设置不能为空'                        
            }          
